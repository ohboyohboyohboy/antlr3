...
# generated at: 2009-11-04 20:01:58
...
module ANTLRv3Grammar
  ...
  class Parser < ANTLR3::Parser
    ...
    def grammar_def
      ...
      in_rule(grammar_file_name, "grammar_def") do
        ...
        begin
          ...
          @debug_listener.location(101, 7)
          g = match(T__70, TOKENS_FOLLOWING_T__70_IN_grammar_def_375) 
          if @state.backtracking == 0
            stream_T__70.add(g)
          end
          @debug_listener.location(101, 18)
          ...
          @debug_listener.location(101, 39)
          ...
          @debug_listener.location(101, 52)
          ...
          @debug_listener.location(101, 64)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(105, 25)
            ...
            @debug_listener.location(105, 39)
            ...
            @debug_listener.location(105, 52)
            ...
            @debug_listener.location(105, 64)
            ...
            stream_action.reset();
            @debug_listener.location(105, 72)
            # at line 105:72: ( rule )+
    ...
    def tokens_spec
      ...
      in_rule(grammar_file_name, "tokens_spec") do
        ...
        begin
          ...
          @debug_listener.location(110, 23)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(110, 30)
            # at line 110:30: ^( TOKENS ( token_spec )+ )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(110, 32)
            root_1 = @adaptor.become_root(stream_TOKENS.next_node, root_1)

            @debug_listener.location(110, 39)
          ...
          in_subrule(10) do
            ...
            when 1
              ...
              in_subrule(9) do
                ...
                when 1
                  ...
                  @debug_listener.location(115, 13)
                ...
                when 2
                  ...
                  @debug_listener.location(115, 32)
            ...
            when 2
              ...
              if @state.backtracking == 0
                ...
                root_0 = @adaptor.create_flat_list!
                # 116:16: -> TOKEN_REF
                @debug_listener.location(116, 19)
    ...
    def attr_scope
      ...
      in_rule(grammar_file_name, "attr_scope") do
        ...
        begin
          ...
          @debug_listener.location(122, 15)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(122, 25)
            # at line 122:25: ^( 'scope' id ACTION )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(122, 27)
            root_1 = @adaptor.become_root(stream_SCOPE.next_node, root_1)

            @debug_listener.location(122, 35)
            @adaptor.add_child(root_1, stream_id.next_tree)
            @debug_listener.location(122, 38)
        ...
        begin
          ...
          in_subrule(11) do
            ...
            when 1
              ...
              @debug_listener.location(127, 27)
          ...
          @debug_listener.location(127, 34)
          ...
          @debug_listener.location(127, 37)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(127, 72)
            @adaptor.add_child(root_1, stream_id.next_tree)
            @debug_listener.location(127, 75)
            @adaptor.add_child(root_1, stream_ACTION.next_node)
    ...
    def action_scope_name
      ...
      in_rule(grammar_file_name, "action_scope_name") do
        @debug_listener.location(130, 1)
        ...
        begin
          ...
          when 2
            ...
            if @state.backtracking == 0
              ...
              root_0 = @adaptor.create_flat_list!
              # 135:16: -> ID[$l]
              @debug_listener.location(135, 19)
          ...
          when 3
            ...
            if @state.backtracking == 0
              ...
              root_0 = @adaptor.create_flat_list!
              # 136:16: -> ID[$p]
              @debug_listener.location(136, 19)
    ...
    def options_spec
      ...
      in_rule(grammar_file_name, "options_spec") do
        ...
        begin
          ...
          in_subrule(13) do
            ...
            loop do
              ...
              when 1
                ...
                @debug_listener.location(140, 13)
                ...
                @debug_listener.location(140, 20)
          ...
          @debug_listener.location(140, 26)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(140, 33)
            # at line 140:33: ^( OPTIONS ( option )+ )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(140, 35)
            root_1 = @adaptor.become_root(stream_OPTIONS.next_node, root_1)

            @debug_listener.location(140, 43)
    ...
    def option
      ...
      in_rule(grammar_file_name, "option") do
        @debug_listener.location(143, 1)
        
        begin
          in_alternative(1)

          # at line 144:9: id '=' option_value
          @debug_listener.location(144, 9)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(144, 32)
            # at line 144:32: ^( '=' id option_value )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(144, 34)
            root_1 = @adaptor.become_root(stream_LABEL_ASSIGN.next_node, root_1)

            @debug_listener.location(144, 38)
            @adaptor.add_child(root_1, stream_id.next_tree)
            @debug_listener.location(144, 41)
    ...
    def option_value
      ...
      in_rule(grammar_file_name, "option_value") do
        @debug_listener.location(147, 1)
        ...
        begin
          ...
          when 5
            ...
            if @state.backtracking == 0
              ...
              @debug_listener.location(152, 16)
    ...
    def rule
      ...
      in_rule(grammar_file_name, "rule") do
        @debug_listener.location(155, 1)
        ...
        begin
          ...
          in_subrule(17) do
            ...
            when 1
              ...
              @debug_listener.location(160, 13)
              ...
              in_subrule(16) do
                ...
                when 1
                  ...
                  @debug_listener.location(160, 15)
                ...
                when 2
                  ...
                  @debug_listener.location(160, 27)
                ...
                when 3
                  ...
                  @debug_listener.location(160, 36)
                ...
                when 4
                  ...
                  @debug_listener.location(160, 46)
          ...
          @debug_listener.location(165, 16)
          ...
          @debug_listener.location(165, 30)
          ...
          @debug_listener.location(165, 47)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(169, 22)
            ...
            stream_options_spec.reset();
            @debug_listener.location(169, 36)
            ...
            @debug_listener.location(169, 53)
            ...
            @debug_listener.location(170, 9)
            @adaptor.add_child(root_1, stream_alt_list.next_tree)
            @debug_listener.location(171, 9)
    ...
    def rule_action
      ...
      stream_ACTION = ANTLR3::AST::RewriteRuleTokenStream.new(@adaptor, "token ACTION")
      stream_id = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule id")
      in_rule(grammar_file_name, "rule_action") do
        @debug_listener.location(176, 1)
        
        begin
          in_alternative(1)

          # at line 178:4: '@' id ACTION
          @debug_listener.location(178, 4)
          char_literal55 = match(AT, TOKENS_FOLLOWING_AT_IN_rule_action_979) 
          if @state.backtracking == 0
            stream_AT.add(char_literal55)
          end
          @debug_listener.location(178, 8)
          ...
          @debug_listener.location(178, 11)
          ...
          if @state.backtracking == 0
            ...
            root_0 = @adaptor.create_flat_list!
            # 178:18: -> ^( '@' id ACTION )
            @debug_listener.location(178, 21)
            # at line 178:21: ^( '@' id ACTION )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(178, 23)
            root_1 = @adaptor.become_root(stream_AT.next_node, root_1)

            @debug_listener.location(178, 27)
            @adaptor.add_child(root_1, stream_id.next_tree)
            @debug_listener.location(178, 30)
            @adaptor.add_child(root_1, stream_ACTION.next_node)
    ...
    def throws_spec
      ...
      in_rule(grammar_file_name, "throws_spec") do
        ...
        begin
          ...
          @debug_listener.location(182, 16)
          # at line 182:16: ( ',' id )*
          in_subrule(26) do
            loop do  #loop 26
              alt_26 = 2
          ...
          if @state.backtracking == 0
            ...
            root_0 = @adaptor.create_flat_list!
            # 182:28: -> ^( 'throws' ( id )+ )
            @debug_listener.location(182, 31)
            # at line 182:31: ^( 'throws' ( id )+ )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(182, 33)
            root_1 = @adaptor.become_root(stream_T__79.next_node, root_1)

            @debug_listener.location(182, 42)
            # at line 182:42: ( id )+
    ...
    def rule_scope_spec
      ...
      stream_ACTION = ANTLR3::AST::RewriteRuleTokenStream.new(@adaptor, "token ACTION")
      stream_id = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule id")
      in_rule(grammar_file_name, "rule_scope_spec") do
        @debug_listener.location(185, 1)
        ...
        begin
          ...
          when 1
            ...
            if @state.backtracking == 0
              ...
              root_0 = @adaptor.create_flat_list!
              # 186:19: -> ^( 'scope' ACTION )
              @debug_listener.location(186, 22)
              # at line 186:22: ^( 'scope' ACTION )
              root_1 = @adaptor.create_flat_list!
              @debug_listener.location(186, 24)
              root_1 = @adaptor.become_root(stream_SCOPE.next_node, root_1)

              @debug_listener.location(186, 32)
              @adaptor.add_child(root_1, stream_ACTION.next_node)
          ...
          when 2
            ...
            @debug_listener.location(187, 15)
            # at line 187:15: ( ',' id )*
            in_subrule(27) do
              loop do  #loop 27
                alt_27 = 2
            ...
            @debug_listener.location(187, 25)
            ...
            if @state.backtracking == 0
              ...
              root_0 = @adaptor.create_flat_list!
              # 187:29: -> ^( 'scope' ( id )+ )
              @debug_listener.location(187, 32)
              # at line 187:32: ^( 'scope' ( id )+ )
              root_1 = @adaptor.create_flat_list!
              @debug_listener.location(187, 34)
              root_1 = @adaptor.become_root(stream_SCOPE.next_node, root_1)

              @debug_listener.location(187, 42)
              # at line 187:42: ( id )+
              unless stream_id.has_next?
                raise ANTLR3::RewriteEarlyExit
              end
          ...
          when 3
            ...
            @debug_listener.location(189, 14)
            # at line 189:14: ( ',' id )*
            in_subrule(28) do
              loop do  #loop 28
                alt_28 = 2
            ...
            @debug_listener.location(189, 24)
            ...
            if @state.backtracking == 0
              ...
              @debug_listener.location(190, 6)
              # at line 190:6: ^( 'scope' ACTION ( id )+ )
              root_1 = @adaptor.create_flat_list!
              @debug_listener.location(190, 8)
              root_1 = @adaptor.become_root(stream_SCOPE.next_node, root_1)

              @debug_listener.location(190, 16)
              @adaptor.add_child(root_1, stream_ACTION.next_node)
              @debug_listener.location(190, 23)
              # at line 190:23: ( id )+
              unless stream_id.has_next?
                raise ANTLR3::RewriteEarlyExit
              end
    ...
    def block
      ...
      stream_options_spec = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule options_spec")
      in_rule(grammar_file_name, "block") do
        @debug_listener.location(193, 1)
        
        begin
          in_alternative(1)

          # at line 194:9: lp= '(' ( (opts= options_spec )? ':' )? altpair ( '|' altpair )* rp= ')'
          @debug_listener.location(194, 11)
          lp = match(T__81, TOKENS_FOLLOWING_T__81_IN_block_1124) 
          if @state.backtracking == 0
            stream_T__81.add(lp)
          end
          @debug_listener.location(195, 3)
            ...
            when 1
              ...
              in_subrule(30) do
                ...
                when 1
                  ...
                  @debug_listener.location(195, 10)
              ...
              @debug_listener.location(195, 26)
          ...
          @debug_listener.location(196, 11)
          ...
          @debug_listener.location(197, 11)
          ...
          if @state.backtracking == 0
            ...
            stream_options_spec.reset();
            @debug_listener.location(198, 48)
            ...
            @debug_listener.location(198, 57)
    ...
    def altpair
      ...
      in_rule(grammar_file_name, "altpair") do
        @debug_listener.location(201, 1)
        ...
        begin
          ...
          @debug_listener.location(201, 11)
          ...
          @debug_listener.location(201, 23)
        ...
        @debug_listener.location(201, 31)
      end
    ...
    def alt_list
      ...
      in_rule(grammar_file_name, "alt_list") do
        @debug_listener.location(203, 1)
        
        begin
          in_alternative(1)

          # at line 207:9: altpair ( '|' altpair )*
          @debug_listener.location(207, 9)
          ...
          @debug_listener.location(207, 17)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(207, 37)
            # at line 207:37: ^( ( altpair )+ EOB[\"eob\"] )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(207, 40)
            root_1 = @adaptor.become_root(block_root, root_1)

            @debug_listener.location(207, 53)
            ...
            stream_altpair.reset
            @debug_listener.location(207, 62)
    ...
    def alternative
      ...
      in_rule(grammar_file_name, "alternative") do
        @debug_listener.location(210, 1)
        ...
        begin
          ...
          when 1
            ...
            if @state.backtracking == 0
              ...
              @debug_listener.location(215, 55)
    ...
    def exception_group
      ...
      in_rule(grammar_file_name, "exception_group") do
        @debug_listener.location(219, 1)
        ...
        begin
          ...
          when 1
            ...
            @debug_listener.location(220, 27)
            ...
            in_subrule(37) do
              ...
              when 1
                ...
                @debug_listener.location(220, 29)
    ...
    def exception_handler
      ...
      in_rule(grammar_file_name, "exception_handler") do
        ...
        begin
          ...
          @debug_listener.location(225, 24)
      ...
      in_rule(grammar_file_name, "finally_clause") do
        ...
        begin
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(229, 25)
            # at line 229:25: ^( 'finally' ACTION )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(229, 27)
            root_1 = @adaptor.become_root(stream_T__85.next_node, root_1)

            @debug_listener.location(229, 37)
            @adaptor.add_child(root_1, stream_ACTION.next_node)
    ...
    def element
      ...
      in_rule(grammar_file_name, "element") do
        @debug_listener.location(232, 1)
          ...
          when 1
            ...
            in_subrule(39) do
              ...
              when 1
                ...
                @debug_listener.location(233, 15)
              ...
              when 2
                ...
                @debug_listener.location(233, 27)
            ...
            @debug_listener.location(233, 34)
            ...
            in_subrule(40) do
              ...
              when 2
                ...
                if @state.backtracking == 0
                  ...
                  @debug_listener.location(235, 11)
                  # at line 235:11: ^( $labelOp id atom )
                  root_1 = @adaptor.create_flat_list!
                  @debug_listener.location(235, 13)
                  root_1 = @adaptor.become_root(stream_labelOp.next_node, root_1)

                  @debug_listener.location(235, 22)
                  @adaptor.add_child(root_1, stream_id.next_tree)
                  @debug_listener.location(235, 25)
          ...
          when 2
            ...
            in_subrule(41) do
              ...
              when 1
                ...
                @debug_listener.location(237, 15)
              ...
              when 2
                ...
                @debug_listener.location(237, 27)
            ...
            @debug_listener.location(237, 34)
            ...
            in_subrule(42) do
              ...
              when 1
                ...
                if @state.backtracking == 0
                  ...
                  @debug_listener.location(238, 20)
                  # at line 238:20: ^( ebnf_suffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] ^( $labelOp id block ) EOA[\"EOA\"] ) EOB[\"EOB\"] ) )
                  root_1 = @adaptor.create_flat_list!
                  @debug_listener.location(238, 23)
                  root_1 = @adaptor.become_root(stream_ebnf_suffix.next_node(), root_1)

                  @debug_listener.location(238, 35)
                  # at line 238:35: ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] ^( $labelOp id block ) EOA[\"EOA\"] ) EOB[\"EOB\"] )
                  root_2 = @adaptor.create_flat_list!
                  @debug_listener.location(238, 37)
                  root_2 = @adaptor.become_root(@adaptor.create!(BLOCK, "BLOCK"), root_2)

                  @debug_listener.location(238, 52)
                  # at line 238:52: ^( ALT[\"ALT\"] ^( $labelOp id block ) EOA[\"EOA\"] )
                  root_3 = @adaptor.create_flat_list!
                  @debug_listener.location(238, 54)
                  root_3 = @adaptor.become_root(@adaptor.create!(ALT, "ALT"), root_3)

                  @debug_listener.location(238, 65)
                  # at line 238:65: ^( $labelOp id block )
                  root_4 = @adaptor.create_flat_list!
                  @debug_listener.location(238, 67)
                  root_4 = @adaptor.become_root(stream_labelOp.next_node, root_4)

                  @debug_listener.location(238, 76)
                  @adaptor.add_child(root_4, stream_id.next_tree)
                  @debug_listener.location(238, 79)
                  @adaptor.add_child(root_4, stream_block.next_tree)

                  @adaptor.add_child(root_3, root_4)
                  @debug_listener.location(238, 86)
                  @adaptor.add_child(root_3, @adaptor.create!(EOA, "EOA"))

                  @adaptor.add_child(root_2, root_3)
                  @debug_listener.location(238, 98)
                  @adaptor.add_child(root_2, @adaptor.create!(EOB, "EOB"))
              ...
              when 2
                ...
                if @state.backtracking == 0
                  ...
                  @debug_listener.location(239, 11)
                  # at line 239:11: ^( $labelOp id block )
                  root_1 = @adaptor.create_flat_list!
                  @debug_listener.location(239, 13)
                  root_1 = @adaptor.become_root(stream_labelOp.next_node, root_1)

                  @debug_listener.location(239, 22)
                  @adaptor.add_child(root_1, stream_id.next_tree)
                  @debug_listener.location(239, 25)
            ...
            in_subrule(43) do
              ...
              when 1
                ...
                if @state.backtracking == 0
                  ...
                  @debug_listener.location(242, 20)
                  # at line 242:20: ^( ebnf_suffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] atom EOA[\"EOA\"] ) EOB[\"EOB\"] ) )
                  root_1 = @adaptor.create_flat_list!
                  @debug_listener.location(242, 23)
                  root_1 = @adaptor.become_root(stream_ebnf_suffix.next_node(), root_1)

                  @debug_listener.location(242, 35)
                  # at line 242:35: ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] atom EOA[\"EOA\"] ) EOB[\"EOB\"] )
                  root_2 = @adaptor.create_flat_list!
                  @debug_listener.location(242, 37)
                  root_2 = @adaptor.become_root(@adaptor.create!(BLOCK, "BLOCK"), root_2)

                  @debug_listener.location(242, 52)
                  # at line 242:52: ^( ALT[\"ALT\"] atom EOA[\"EOA\"] )
                  root_3 = @adaptor.create_flat_list!
                  @debug_listener.location(242, 54)
                  root_3 = @adaptor.become_root(@adaptor.create!(ALT, "ALT"), root_3)

                  @debug_listener.location(242, 65)
                  @adaptor.add_child(root_3, stream_atom.next_tree)
                  @debug_listener.location(242, 70)
                  @adaptor.add_child(root_3, @adaptor.create!(EOA, "EOA"))

                  @adaptor.add_child(root_2, root_3)
                  @debug_listener.location(242, 82)
                  @adaptor.add_child(root_2, @adaptor.create!(EOB, "EOB"))
              ...
              when 2
                ...
                if @state.backtracking == 0
                  ...
                  root_0 = @adaptor.create_flat_list!
                  # 243:8: -> atom
                  @debug_listener.location(243, 11)
          ...
          when 6
            ...
            in_subrule(44) do
              ...
              when 1
                ...
                # at line 247:16: g= '=>'
                @debug_listener.location(247, 17)
                ...
                if @state.backtracking == 0
                  ...
                  @debug_listener.location(247, 26)
              ...
              when 2
                ...
                if @state.backtracking == 0
                  ...
                  root_0 = @adaptor.create_flat_list!
                  # 247:46: -> SEMPRED
                  @debug_listener.location(247, 49)
            ...
            in_subrule(45) do
              ...
              when 1
                ...
                if @state.backtracking == 0
                  ...
                  @debug_listener.location(249, 20)
                  # at line 249:20: ^( ebnf_suffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] tree_spec EOA[\"EOA\"] ) EOB[\"EOB\"] ) )
                  root_1 = @adaptor.create_flat_list!
                  @debug_listener.location(249, 23)
                  root_1 = @adaptor.become_root(stream_ebnf_suffix.next_node(), root_1)

                  @debug_listener.location(249, 35)
                  # at line 249:35: ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] tree_spec EOA[\"EOA\"] ) EOB[\"EOB\"] )
                  root_2 = @adaptor.create_flat_list!
                  @debug_listener.location(249, 37)
                  root_2 = @adaptor.become_root(@adaptor.create!(BLOCK, "BLOCK"), root_2)

                  @debug_listener.location(249, 52)
                  # at line 249:52: ^( ALT[\"ALT\"] tree_spec EOA[\"EOA\"] )
                  root_3 = @adaptor.create_flat_list!
                  @debug_listener.location(249, 54)
                  root_3 = @adaptor.become_root(@adaptor.create!(ALT, "ALT"), root_3)

                  @debug_listener.location(249, 65)
                  @adaptor.add_child(root_3, stream_tree_spec.next_tree)
                  @debug_listener.location(249, 75)
                  @adaptor.add_child(root_3, @adaptor.create!(EOA, "EOA"))

                  @adaptor.add_child(root_2, root_3)
                  @debug_listener.location(249, 87)
                  @adaptor.add_child(root_2, @adaptor.create!(EOB, "EOB"))
              ...
              when 2
                ...
                if @state.backtracking == 0
                  ...
                  root_0 = @adaptor.create_flat_list!
                  # 250:8: -> tree_spec
                  @debug_listener.location(250, 11)
    ...
    def atom
      ...
      in_rule(grammar_file_name, "atom") do
        @debug_listener.location(254, 1)
            ...
            in_subrule(48) do
              ...
              when 1
                ...
                in_subrule(47) do
                  ...
                  when 2
                    ...
                    # at line 256:13: op= '!'
                    @debug_listener.location(256, 15)
                ...
                if @state.backtracking == 0
                  ...
                  root_0 = @adaptor.create_flat_list!
                  # 256:21: -> ^( $op range )
                  @debug_listener.location(256, 24)
                  # at line 256:24: ^( $op range )
                  root_1 = @adaptor.create_flat_list!
                  @debug_listener.location(256, 26)
                  root_1 = @adaptor.become_root(stream_op.next_node, root_1)

                  @debug_listener.location(256, 30)
              ...
              when 2
                ...
                if @state.backtracking == 0
                  ...
                  root_0 = @adaptor.create_flat_list!
                  # 257:9: -> range
                  @debug_listener.location(257, 12)
            ...
            in_subrule(50) do
              ...
              when 1
                ...
                in_subrule(49) do
                  ...
                  when 2
                    ...
                    # at line 260:13: op= '!'
                    @debug_listener.location(260, 15)
                ...
                if @state.backtracking == 0
                  ...
                  root_0 = @adaptor.create_flat_list!
                  # 260:21: -> ^( $op not_set )
                  @debug_listener.location(260, 24)
                  # at line 260:24: ^( $op not_set )
                  root_1 = @adaptor.create_flat_list!
                  @debug_listener.location(260, 26)
                  root_1 = @adaptor.become_root(stream_op.next_node, root_1)

                  @debug_listener.location(260, 30)
              ...
              when 2
                ...
                if @state.backtracking == 0
                  ...
                  root_0 = @adaptor.create_flat_list!
                  # 261:9: -> not_set
                  @debug_listener.location(261, 12)
              ...
              when 1
                ...
                in_subrule(52) do
                  ...
                  when 2
                    ...
                    # at line 264:13: op= '!'
                    @debug_listener.location(264, 15)
                ...
                if @state.backtracking == 0
                  ...
                  @debug_listener.location(264, 24)
                  # at line 264:24: ^( $op RULE_REF ( ARG_ACTION )? )
                  root_1 = @adaptor.create_flat_list!
                  @debug_listener.location(264, 26)
                  root_1 = @adaptor.become_root(stream_op.next_node, root_1)

                  @debug_listener.location(264, 30)
                  @adaptor.add_child(root_1, stream_RULE_REF.next_node)
                  @debug_listener.location(264, 39)
        ...
        begin
          ...
          in_subrule(57) do
            ...
            when 1
              ...
              @debug_listener.location(271, 18)
            ...
            when 2
              ...
              @debug_listener.location(272, 11)
              ...
              if @state.backtracking == 0
                ...
                @debug_listener.location(272, 32)
                # at line 272:32: ^( '~' block ( element_options )? )
                root_1 = @adaptor.create_flat_list!
                @debug_listener.location(272, 34)
                root_1 = @adaptor.become_root(stream_T__87.next_node, root_1)

                @debug_listener.location(272, 38)
                @adaptor.add_child(root_1, stream_block.next_tree)
                @debug_listener.location(272, 44)
    ...
    def not_terminal
      ...
      in_rule(grammar_file_name, "not_terminal") do
        @debug_listener.location(276, 1)
        ...
        begin
          ...
          if @input.peek(1).between?(TOKEN_REF, CHAR_LITERAL)
            ...
            @debug_listener.recognition_exception(mse)
            raise mse
          end
    ...
    def element_options
      ...
      stream_option = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule option")
      in_rule(grammar_file_name, "element_options") do
        @debug_listener.location(282, 1)
        ...
        begin
          ...
          when 1
            ...
            @debug_listener.location(283, 12)
          ...
          when 2
            ...
            @debug_listener.location(284, 15)
            ...
            @debug_listener.location(284, 29)
            ...
            if @state.backtracking == 0
              ...
              @debug_listener.location(284, 36)
              # at line 284:36: ^( OPTIONS ( option )+ )
              root_1 = @adaptor.create_flat_list!
              @debug_listener.location(284, 38)
              root_1 = @adaptor.become_root(@adaptor.create_from_type!(OPTIONS, "OPTIONS"), root_1)

              @debug_listener.location(284, 46)
    ...
    def element_option
      ...
      stream_id = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule id")
      stream_option_value = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule option_value")
      in_rule(grammar_file_name, "element_option") do
        @debug_listener.location(287, 1)
        
        begin
          in_alternative(1)

          # at line 288:4: id '=' option_value
          @debug_listener.location(288, 4)
          ...
          @debug_listener.location(288, 11)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(288, 27)
            # at line 288:27: ^( '=' id option_value )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(288, 29)
            root_1 = @adaptor.become_root(stream_LABEL_ASSIGN.next_node, root_1)

            @debug_listener.location(288, 33)
            @adaptor.add_child(root_1, stream_id.next_tree)
            @debug_listener.location(288, 36)
            @adaptor.add_child(root_1, stream_option_value.next_tree)
    ...
    def tree_spec
      ...
      in_rule(grammar_file_name, "tree_spec") do
        ...
        begin
          ...
          @debug_listener.location(292, 17)
          ...
          in_subrule(60) do
            ...
            loop do
              ...
              when 1
                ...
                @debug_listener.location(292, 19)
          ...
          @debug_listener.location(292, 30)
    ...
    def terminal
      ...
      stream_ARG_ACTION = ANTLR3::AST::RewriteRuleTokenStream.new(@adaptor, "token ARG_ACTION")
      stream_element_options = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule element_options")
      in_rule(grammar_file_name, "terminal") do
        @debug_listener.location(300, 1)
        ...
        begin
          ...
          in_subrule(67) do
            ...
            when 1
              ...
              @debug_listener.location(301, 11)
              ...
              @debug_listener.location(301, 24)
            ...
            when 2
              ...
              @debug_listener.location(303, 29)
              ...
              if @state.backtracking == 0
                ...
                stream_ARG_ACTION.reset();
                @debug_listener.location(303, 73)
            ...
            when 3
              ...
              @debug_listener.location(304, 22)
            ...
            when 4
              ...
              if @state.backtracking == 0
                ...
                @debug_listener.location(305, 38)
                # at line 305:38: ^( '.' ( element_options )? )
                root_1 = @adaptor.create_flat_list!
                @debug_listener.location(305, 40)
                root_1 = @adaptor.become_root(stream_T__90.next_node, root_1)

                @debug_listener.location(305, 44)
          ...
          in_subrule(68) do
            ...
            when 1
              ...
              if @state.backtracking == 0
                ...
                root_0 = @adaptor.create_flat_list!
                # 307:15: -> ^( '^' $terminal)
                @debug_listener.location(307, 18)
                # at line 307:18: ^( '^' $terminal)
                root_1 = @adaptor.create_flat_list!
                @debug_listener.location(307, 20)
                root_1 = @adaptor.become_root(stream_ROOT.next_node, root_1)

                @debug_listener.location(307, 24)
            ...
            when 2
              ...
              if @state.backtracking == 0
                ...
                root_0 = @adaptor.create_flat_list!
                # 308:15: -> ^( '!' $terminal)
                @debug_listener.location(308, 18)
                # at line 308:18: ^( '!' $terminal)
                root_1 = @adaptor.create_flat_list!
                @debug_listener.location(308, 20)
                root_1 = @adaptor.become_root(stream_BANG.next_node, root_1)

                @debug_listener.location(308, 24)
                @adaptor.add_child(root_1, stream_return_value.next_tree)
    ...
    def ebnf
      ...
      in_rule(grammar_file_name, "ebnf") do
        @debug_listener.location(312, 1)
        
        begin
          in_alternative(1)

          # at line 319:4: block (op= '?' -> ^( OPTIONAL[$op] block ) | op= '*' -> ^( CLOSURE[$op] block ) | op= '+' -> ^( POSITIVE_CLOSURE[$op] block ) | '=>' -> { \n @grammar_type == COMBINED_GRAMMAR && $rule::name[0].between?(?A, ?Z)\n }? ^( SYNPRED[\"=>\"] block ) -> SYN_SEMPRED | -> block )
          @debug_listener.location(319, 4)
          ...
          in_subrule(69) do
            ...
            when 2
              ...
              if @state.backtracking == 0
                ...
                @debug_listener.location(321, 15)
                # at line 321:15: ^( CLOSURE[$op] block )
                root_1 = @adaptor.create_flat_list!
                @debug_listener.location(321, 17)
                root_1 = @adaptor.become_root(@adaptor.create!(CLOSURE, op), root_1)

                @debug_listener.location(321, 30)
                @adaptor.add_child(root_1, stream_block.next_tree)
            ...
            when 4
              ...
              if @state.backtracking == 0
                ...
                if  
                  ...
                  # 324:6: -> { \n @grammar_type == COMBINED_GRAMMAR && $rule::name[0].between?(?A, ?Z)\n }? ^( SYNPRED[\"=>\"] block )
                  @debug_listener.location(328, 9)
                  # at line 328:9: ^( SYNPRED[\"=>\"] block )
                  root_1 = @adaptor.create_flat_list!
                  @debug_listener.location(328, 11)
                  root_1 = @adaptor.become_root(@adaptor.create!(SYNPRED, "=>"), root_1)

                  @debug_listener.location(328, 25)
                  @adaptor.add_child(root_1, stream_block.next_tree)
            ...
            when 5
              ...
              if @state.backtracking == 0
                ...
                root_0 = @adaptor.create_flat_list!
                # 331:13: -> block
                @debug_listener.location(331, 16)
    ...
    def ebnf_suffix
      ...
      in_rule(grammar_file_name, "ebnf_suffix") do
        @debug_listener.location(335, 1)
        ...
        begin
          ...
          when 1
            ...
            if @state.backtracking == 0
              ...
              root_0 = @adaptor.create_flat_list!
              # 339:8: -> OPTIONAL[op]
              @debug_listener.location(339, 11)
          ...
          when 2
            ...
            if @state.backtracking == 0
              ...
              root_0 = @adaptor.create_flat_list!
              # 340:10: -> CLOSURE[op]
              @debug_listener.location(340, 13)
          ...
          when 3
            ...
            if @state.backtracking == 0
              ...
              @debug_listener.location(341, 14)
    ...
    def rewrite
      ...
      in_rule(grammar_file_name, "rewrite") do
        @debug_listener.location(348, 1)
        ...
        begin
          ...
          when 1
            ...
            in_subrule(71) do
              loop do  #loop 71
                ...
                when 1
                  ...
                  @debug_listener.location(352, 20)
                  ...
                  @debug_listener.location(352, 40)
            ...
            if @state.backtracking == 0
              ...
              stream_rew.reset();
              stream_preds.reset();
              @debug_listener.location(354, 40)
              # at line 354:40: ^( $rew2 $last)
              root_1 = @adaptor.create_flat_list!
              @debug_listener.location(354, 42)
              root_1 = @adaptor.become_root(stream_rew2.next_node, root_1)

              @debug_listener.location(354, 48)
    ...
    def rewrite_alternative
      ...
      in_rule(grammar_file_name, "rewrite_alternative") do
        @debug_listener.location(358, 1)
    ...
    def rewrite_tree_block
      ...
      in_rule(grammar_file_name, "rewrite_tree_block") do
        @debug_listener.location(365, 1)
        
        begin
          in_alternative(1)

          # at line 366:9: lp= '(' rewrite_tree_alternative ')'
          @debug_listener.location(366, 11)
          lp = match(T__81, TOKENS_FOLLOWING_T__81_IN_rewrite_tree_block_2596) 
          if @state.backtracking == 0
            stream_T__81.add(lp)
          end
          @debug_listener.location(366, 16)
          ...
          @debug_listener.location(366, 41)
    ...
    def rewrite_tree_alternative
      ...
      in_rule(grammar_file_name, "rewrite_tree_alternative") do
        @debug_listener.location(370, 1)
        
        begin
          in_alternative(1)

          # at line 371:7: ( rewrite_tree_element )+
          @debug_listener.location(371, 7)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(371, 32)
            # at line 371:32: ^( ALT[\"ALT\"] ( rewrite_tree_element )+ EOA[\"EOA\"] )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(371, 34)
            root_1 = @adaptor.become_root(@adaptor.create!(ALT, "ALT"), root_1)

            @debug_listener.location(371, 45)
            ...
            @debug_listener.location(371, 67)
            @adaptor.add_child(root_1, @adaptor.create!(EOA, "EOA"))
    ...
    def rewrite_tree_element
      ...
      stream_ebnf_suffix = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule ebnf_suffix")
      in_rule(grammar_file_name, "rewrite_tree_element") do
        @debug_listener.location(374, 1)
        ...
        begin
          ...
          when 2
            ...
            @debug_listener.location(376, 22)
            ...
            if @state.backtracking == 0
              ...
              @debug_listener.location(377, 6)
              # at line 377:6: ^( ebnf_suffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree_atom EOA[\"EOA\"] ) EOB[\"EOB\"] ) )
              root_1 = @adaptor.create_flat_list!
              @debug_listener.location(377, 9)
              root_1 = @adaptor.become_root(stream_ebnf_suffix.next_node(), root_1)

              @debug_listener.location(377, 21)
              # at line 377:21: ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree_atom EOA[\"EOA\"] ) EOB[\"EOB\"] )
              root_2 = @adaptor.create_flat_list!
              @debug_listener.location(377, 23)
              root_2 = @adaptor.become_root(@adaptor.create!(BLOCK, "BLOCK"), root_2)

              @debug_listener.location(377, 38)
              # at line 377:38: ^( ALT[\"ALT\"] rewrite_tree_atom EOA[\"EOA\"] )
              root_3 = @adaptor.create_flat_list!
              @debug_listener.location(377, 40)
              root_3 = @adaptor.become_root(@adaptor.create!(ALT, "ALT"), root_3)

              @debug_listener.location(377, 51)
              @adaptor.add_child(root_3, stream_rewrite_tree_atom.next_tree)
              @debug_listener.location(377, 69)
              @adaptor.add_child(root_3, @adaptor.create!(EOA, "EOA"))

              @adaptor.add_child(root_2, root_3)
              @debug_listener.location(377, 81)
              @adaptor.add_child(root_2, @adaptor.create!(EOB, "EOB"))
            ...
            in_subrule(75) do
              ...
              when 1
                ...
                if @state.backtracking == 0
                  ...
                  @debug_listener.location(380, 7)
                  # at line 380:7: ^( ebnf_suffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree EOA[\"EOA\"] ) EOB[\"EOB\"] ) )
                  root_1 = @adaptor.create_flat_list!
                  @debug_listener.location(380, 9)
                  root_1 = @adaptor.become_root(stream_ebnf_suffix.next_node(), root_1)

                  @debug_listener.location(380, 21)
                  # at line 380:21: ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree EOA[\"EOA\"] ) EOB[\"EOB\"] )
                  root_2 = @adaptor.create_flat_list!
                  @debug_listener.location(380, 23)
                  root_2 = @adaptor.become_root(@adaptor.create!(BLOCK, "BLOCK"), root_2)

                  @debug_listener.location(380, 38)
                  # at line 380:38: ^( ALT[\"ALT\"] rewrite_tree EOA[\"EOA\"] )
                  root_3 = @adaptor.create_flat_list!
                  @debug_listener.location(380, 40)
                  root_3 = @adaptor.become_root(@adaptor.create!(ALT, "ALT"), root_3)

                  @debug_listener.location(380, 51)
                  @adaptor.add_child(root_3, stream_rewrite_tree.next_tree)
                  @debug_listener.location(380, 64)
                  @adaptor.add_child(root_3, @adaptor.create!(EOA, "EOA"))

                  @adaptor.add_child(root_2, root_3)
                  @debug_listener.location(380, 76)
                  @adaptor.add_child(root_2, @adaptor.create!(EOB, "EOB"))
    ...
    def rewrite_tree_atom
      ...
      stream_ARG_ACTION = ANTLR3::AST::RewriteRuleTokenStream.new(@adaptor, "token ARG_ACTION")
      stream_id = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule id")
      in_rule(grammar_file_name, "rewrite_tree_atom") do
        @debug_listener.location(386, 1)
        ...
        begin
          ...
          when 2
            ...
            @debug_listener.location(388, 16)
            ...
            if @state.backtracking == 0
              ...
              @debug_listener.location(388, 31)
              # at line 388:31: ^( TOKEN_REF ( ARG_ACTION )? )
              root_1 = @adaptor.create_flat_list!
              @debug_listener.location(388, 33)
              root_1 = @adaptor.become_root(stream_TOKEN_REF.next_node, root_1)

              @debug_listener.location(388, 43)
          ...
          when 5
            ...
            if @state.backtracking == 0
              ...
              @debug_listener.location(391, 18)
    ...
    def rewrite_tree_ebnf
      ...
      in_rule(grammar_file_name, "rewrite_tree_ebnf") do
        @debug_listener.location(395, 1)
        
        begin
          in_alternative(1)

          # at line 403:4: rewrite_tree_block ebnf_suffix
          @debug_listener.location(403, 4)
          ...
          @debug_listener.location(403, 23)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(403, 38)
            # at line 403:38: ^( ebnf_suffix rewrite_tree_block )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(403, 40)
            root_1 = @adaptor.become_root(stream_ebnf_suffix.next_node(), root_1)

            @debug_listener.location(403, 52)
    ...
    def rewrite_tree
      ...
      stream_rewrite_tree_element = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule rewrite_tree_element")
      stream_rewrite_tree_atom = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule rewrite_tree_atom")
      in_rule(grammar_file_name, "rewrite_tree") do
        @debug_listener.location(406, 1)
        
        begin
          in_alternative(1)

          # at line 407:4: '^(' rewrite_tree_atom ( rewrite_tree_element )* ')'
          @debug_listener.location(407, 4)
          ...
          @debug_listener.location(407, 27)
          ...
          @debug_listener.location(407, 49)
    ...
    def rewrite_template
      ...
      in_rule(grammar_file_name, "rewrite_template") do
        @debug_listener.location(411, 1)
          ...
          when 1
            ...
            in_subrule(80) do
              ...
              when 2
                ...
                @debug_listener.location(425, 42)
    ...
    def rewrite_template_ref
      ...
      stream_id = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule id")
      stream_rewrite_template_args = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule rewrite_template_args")
      in_rule(grammar_file_name, "rewrite_template_ref") do
        @debug_listener.location(438, 1)
        
        begin
          in_alternative(1)

          # at line 440:4: id lp= '(' rewrite_template_args ')'
          @debug_listener.location(440, 4)
          ...
          @debug_listener.location(440, 36)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(441, 6)
            # at line 441:6: ^( TEMPLATE[$lp,\"TEMPLATE\"] id rewrite_template_args )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(441, 8)
            root_1 = @adaptor.become_root(@adaptor.create!(TEMPLATE, lp, "TEMPLATE"), root_1)

            @debug_listener.location(441, 33)
            @adaptor.add_child(root_1, stream_id.next_tree)
            @debug_listener.location(441, 36)
            @adaptor.add_child(root_1, stream_rewrite_template_args.next_tree)
    ...
    def rewrite_indirect_template_head
      ...
      in_rule(grammar_file_name, "rewrite_indirect_template_head") do
        ...
        begin
          ...
          @debug_listener.location(446, 22)
          ...
          @debug_listener.location(446, 26)
          ...
          @debug_listener.location(446, 48)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(447, 6)
            # at line 447:6: ^( TEMPLATE[$lp,\"TEMPLATE\"] ACTION rewrite_template_args )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(447, 8)
            root_1 = @adaptor.become_root(@adaptor.create!(TEMPLATE, lp, "TEMPLATE"), root_1)

            @debug_listener.location(447, 33)
            @adaptor.add_child(root_1, stream_ACTION.next_node)
            @debug_listener.location(447, 40)
            @adaptor.add_child(root_1, stream_rewrite_template_args.next_tree)
    ...
    def rewrite_template_args
      ...
      in_rule(grammar_file_name, "rewrite_template_args") do
        @debug_listener.location(450, 1)
        ...
        begin
          ...
          when 1
            ...
            @debug_listener.location(451, 25)
    ...
    def rewrite_template_arg
      ...
      stream_ACTION = ANTLR3::AST::RewriteRuleTokenStream.new(@adaptor, "token ACTION")
      stream_id = ANTLR3::AST::RewriteRuleSubtreeStream.new(@adaptor, "rule id")
      in_rule(grammar_file_name, "rewrite_template_arg") do
        @debug_listener.location(456, 1)
        
        begin
          in_alternative(1)

          # at line 457:6: id '=' ACTION
          @debug_listener.location(457, 6)
          ...
          @debug_listener.location(457, 13)
          ...
          if @state.backtracking == 0
            ...
            @debug_listener.location(457, 23)
            # at line 457:23: ^( ARG[$id.start] id ACTION )
            root_1 = @adaptor.create_flat_list!
            @debug_listener.location(457, 25)
            root_1 = @adaptor.become_root(@adaptor.create!(ARG, id192.start), root_1)

            @debug_listener.location(457, 40)
            @adaptor.add_child(root_1, stream_id.next_tree)
            @debug_listener.location(457, 43)
            @adaptor.add_child(root_1, stream_ACTION.next_node)
    ...
    def qid
      ...
      in_rule(grammar_file_name, "qid") do
        @debug_listener.location(460, 1)
        ...
        begin
          ...
          @debug_listener.location(460, 10)
          # at line 460:10: ( '.' id )*
          in_subrule(84) do
            loop do  #loop 84
              alt_84 = 2
              ...
              when 1
                ...
                # at line 460:11: '.' id
                @debug_listener.location(460, 11)
                ...
                @debug_listener.location(460, 15)
        ...
        @debug_listener.location(460, 20)
      end
    ...
    def id
      ...
      in_rule(grammar_file_name, "id") do
        @debug_listener.location(462, 1)
        ...
        begin
          ...
          when 1
            ...
            if @state.backtracking == 0
              ...
              root_0 = @adaptor.create_flat_list!
              # 463:14: -> ID[$TOKEN_REF]
              @debug_listener.location(463, 17)
          ...
          when 2
            ...
            if @state.backtracking == 0
              ...
              root_0 = @adaptor.create_flat_list!
              # 464:14: -> ID[$RULE_REF]
              @debug_listener.location(464, 17)
