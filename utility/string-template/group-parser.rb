...
# from racc grammer file "lib/string-template/group-parser.y".
#
...
class GroupParser < Racc::Parser

module_eval <<'..end lib/string-template/group-parser.y modeval..id1dee3306bf', 'lib/string-template/group-parser.y', 146
...
..end lib/string-template/group-parser.y modeval..id1dee3306bf
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 7
  def _reduce_1( val, _values)
 @group
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 9
  def _reduce_2( val, _values)
 @group.name = val[1].text
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 10
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 16
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 20
  def _reduce_9( val, _values)
 @group.interfaces << val[0].text
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 24
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 28
  def _reduce_13( val, _values)
 add!
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 29
  def _reduce_14( val, _values)
 add!
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 31
  def _reduce_15( val, _values)
 template!
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 36
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 41
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 46
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 50
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 55
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 59
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 63
  def _reduce_25( val, _values)
 @member.parameter!(val[0].text)
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 68
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 72
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 77
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 81
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 82
  def _reduce_30( val, _values)
 type_map!
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 85
  def _reduce_31( val, _values)
                          @member.name = val[0]
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 88
  def _reduce_32( val, _values)
                          alias!(val[0], val[2])
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 89
  def _reduce_33( val, _values)
 @finish = val[1].index
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 90
  def _reduce_34( val, _values)
 @finish = val[2].index
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 91
  def _reduce_35( val, _values)
 @finish = val[2].index
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 92
...
module_eval <<'.,.,', 'lib/string-template/group-parser.y', 100
  def _reduce_39( val, _values)
                          @member.pair! string_literal(val[0]), val[2]
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 101
  def _reduce_40( val, _values)
 @member.default = val[2]
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 103
  def _reduce_41( val, _values)
 string_literal val[0]
  end
.,.,

module_eval <<'.,.,', 'lib/string-template/group-parser.y', 104
