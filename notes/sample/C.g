...
@init {
	...
	: 'typedef' declaration_specifiers? { $declaration::isTypedef=True }
	  init_declarator_list attribute_specifier* ';' // special case, looking for typedef	
	| declaration_specifiers init_declarator_list? attribute_specifier*';'
	;

declaration_specifiers
	: attribute_specifier*  (   storage_class_specifier
		|   type_specifier
        |   type_qualifier
        )+
	;
...
declarator
	: attribute_specifier* pointer? direct_declarator
	| attribute_specifier* pointer
	;
...
declarator_suffix
    ...
    |   '(' identifier_list ')' attribute_specifier*
    |   '(' ')' attribute_specifier*
	;
...
attribute
    ...
    | IDENTIFIER '(' IDENTIFIER ',' attribute_parameter_list ')'
