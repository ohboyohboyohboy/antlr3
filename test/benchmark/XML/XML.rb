...
# input grammar file: /home/kyle/lib/ruby/projects/antlr3/test/benchmark/XML/XML.g
# generated at: 2009-12-18 12:28:43
...
module XML
  ...
  class Lexer < ANTLR3::Lexer
    ...
    begin
      generated_using('/home/kyle/lib/ruby/projects/antlr3/test/benchmark/XML/XML.g', '3.2.1-SNAPSHOT Dec 18, 2009 04:29:28')
    ...
    # (in /home/kyle/lib/ruby/projects/antlr3/test/benchmark/XML/XML.g)
    def document!
    ...
    def pi!
      ...
      match("<?")
      target_start_246 = self.character_index
      generic_id!
      target = create_token do |t|
        t.input   = @input
        t.type    = ANTLR3::INVALID_TOKEN_TYPE
        t.channel = ANTLR3::DEFAULT_CHANNEL
        t.start   = target_start_246
        t.stop    = self.character_index - 1
      end
      # at line 24:38: ( WS )?
      alt_11 = 2
      ...
      when 1
        ...
        loop do  #loop 17
          ...
          when 2
            ...
            t_start_359 = self.character_index
            pcdata!
            t = create_token do |t|
              t.input   = @input
              t.type    = ANTLR3::INVALID_TOKEN_TYPE
          ...
          when 3
            ...
            t_start_377 = self.character_index
            cdata!
            t = create_token do |t|
              t.input   = @input
              t.type    = ANTLR3::INVALID_TOKEN_TYPE
          ...
          when 4
            ...
            t_start_395 = self.character_index
            comment!
            t = create_token do |t|
              t.input   = @input
              t.type    = ANTLR3::INVALID_TOKEN_TYPE
          ...
          when 5
            # at line 35:15: pi= PI
            pi_start_413 = self.character_index
            pi!
            pi = create_token do |t|
              t.input   = @input
              t.type    = ANTLR3::INVALID_TOKEN_TYPE
              t.channel = ANTLR3::DEFAULT_CHANNEL
              t.start   = pi_start_413
              t.stop    = self.character_index - 1
            end
    ...
    def start_tag!
      ...
      name_start_487 = self.character_index
      generic_id!
      name = create_token do |t|
        t.input   = @input
        t.type    = ANTLR3::INVALID_TOKEN_TYPE
        t.channel = ANTLR3::DEFAULT_CHANNEL
        t.start   = name_start_487
        t.stop    = self.character_index - 1
      end
      # at line 43:31: ( WS )?
      alt_20 = 2
    ...
    def empty_element!
      ...
      name_start_535 = self.character_index
      generic_id!
      name = create_token do |t|
        t.input   = @input
        t.type    = ANTLR3::INVALID_TOKEN_TYPE
        t.channel = ANTLR3::DEFAULT_CHANNEL
        t.start   = name_start_535
        t.stop    = self.character_index - 1
      end
      # at line 48:31: ( WS )?
      alt_24 = 2
    ...
    def attribute!
      ...
      name_start_572 = self.character_index
      generic_id!
      name = create_token do |t|
        t.input   = @input
        t.type    = ANTLR3::INVALID_TOKEN_TYPE
        t.channel = ANTLR3::DEFAULT_CHANNEL
        t.start   = name_start_572
        t.stop    = self.character_index - 1
      end
      # at line 52:23: ( WS )?
      alt_27 = 2
      ...
      value_start_584 = self.character_index
      value!
      value = create_token do |t|
        t.input   = @input
        t.type    = ANTLR3::INVALID_TOKEN_TYPE
        t.channel = ANTLR3::DEFAULT_CHANNEL
        t.start   = value_start_584
        t.stop    = self.character_index - 1
      end
    ...
    def end_tag!
      ...
      name_start_611 = self.character_index
      generic_id!
      name = create_token do |t|
        t.input   = @input
        t.type    = ANTLR3::INVALID_TOKEN_TYPE
        t.channel = ANTLR3::DEFAULT_CHANNEL
        t.start   = name_start_611
        t.stop    = self.character_index - 1
      end
      # at line 56:32: ( WS )?
      alt_30 = 2
    ...
    def comment!
      ...
      # - - - - main rule block - - - -
      # at line 60:5: '<!--' ( options {greedy=false; } : . )* '-->'
      match("<!--")
      # at line 60:12: ( options {greedy=false; } : . )*
      loop do  #loop 31
        alt_31 = 2
