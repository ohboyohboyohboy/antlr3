...
ifexpression
                : IDENTIFIER { @input.look(-2).text == "ifndef" }? -> ^(EXPR_NDEF  IDENTIFIER)
                | IDENTIFIER { @input.look(-2).text == "ifdef"  }? -> ^(EXPR_DEF   IDENTIFIER)
                | assignment_expression -> ^(EXPR assignment_expression)
                ;

assignment_expression
                :       conditional_expression
                        ( (ASSIGNEQUAL^ |   TIMESEQUAL^ |   DIVIDEEQUAL^ |   MODEQUAL^ |   PLUSEQUAL^ |   MINUSEQUAL^ |   SHIFTLEFTEQUAL^ |   SHIFTRIGHTEQUAL^ |   BITWISEANDEQUAL^ |   BITWISEXOREQUAL^ |   BITWISEOREQUAL^) assignment_expression )?
                ;
