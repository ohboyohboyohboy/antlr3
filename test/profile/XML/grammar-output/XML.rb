...
# generated at: 2009-09-24 06:45:36
...
module XML
  ...
  module TokenData
    ...
    TokenData.define_tokens(:CDATA => 16, :END_TAG => 18, :EMPTY_ELEMENT => 19, 
                            :LETTER => 20, :ATTRIBUTE => 12, :XMLDECL => 4, :START_TAG => 14, 
                            :VALUE => 10, :INTERNAL_DTD => 11, :EOF => -1, :PCDATA => 15, 
                            :WS => 5, :DOCUMENT => 8, :GENERIC_ID => 9, :ELEMENT => 7, 
                            :DOCTYPE => 6, :PI => 13, :COMMENT => 17)
  end
  ...
  class Lexer < ANTLR3::Lexer
    ...
    begin
      generated_using('./test/benchmark/XML/XML.g', '3.1.3 Sep 23, 2009 20:15:10')
    ...
    class DFA18 < ANTLR3::DFA
      EOT = unpack(48, -1)
      EOF = unpack(48, -1)
      MIN = unpack(1, 60, 13, 9, 2, -1, 14, 9, 2, 0, 6, 9, 1, 0, 1, 9, 1, 0, 7, 
                   9)
      MAX = unpack(1, 60, 13, 122, 2, -1, 6, 122, 1, 39, 3, 122, 4, 39, 2, -1, 1, 
                   122, 4, 61, 1, 39, 1, -1, 1, 122, 1, -1, 1, 122, 1, 61, 5, 122)
      ACCEPT = unpack(14, -1, 1, 1, 1, 2, 32, -1)
      SPECIAL = unpack(30, -1, 1, 3, 1, 1, 6, -1, 1, 2, 1, -1, 1, 0, 7, -1)
      TRANSITION = [
        unpack(1, 1),
        unpack(1, 3, 1, 4, 2, -1, 1, 5, 18, -1, 1, 2, 25, -1, 1, 6, 6, -1, 26, 
                6, 4, -1, 1, 6, 1, -1, 26, 6),
        unpack(1, 3, 1, 4, 2, -1, 1, 5, 18, -1, 1, 2, 25, -1, 1, 6, 6, -1, 26, 
                6, 4, -1, 1, 6, 1, -1, 26, 6),
        unpack(1, 3, 1, 4, 2, -1, 1, 5, 18, -1, 1, 2, 25, -1, 1, 6, 6, -1, 26, 
        ...
        unpack(1, 3, 1, 4, 2, -1, 1, 5, 18, -1, 1, 2, 25, -1, 1, 6, 6, -1, 26, 
                6, 4, -1, 1, 6, 1, -1, 26, 6),
        unpack(1, 3, 1, 7, 2, -1, 1, 5, 18, -1, 1, 2, 25, -1, 1, 6, 6, -1, 26, 
                6, 4, -1, 1, 6, 1, -1, 26, 6),
        unpack(1, 10, 1, 11, 2, -1, 1, 12, 18, -1, 1, 9, 12, -1, 2, 13, 1, 15, 
                10, 13, 1, 8, 3, -1, 1, 14, 2, -1, 26, 8, 4, -1, 1, 8, 1, -1, 26, 
                8),
        unpack(1, 3, 1, 4, 2, -1, 1, 5, 18, -1, 1, 2, 25, -1, 1, 6, 6, -1, 26, 
                6, 4, -1, 1, 6, 1, -1, 26, 6),
        unpack(1, 17, 1, 18, 2, -1, 1, 19, 18, -1, 1, 16, 12, -1, 2, 21, 1, 15, 
                10, 21, 1, 20, 2, -1, 1, 22, 1, 14, 2, -1, 26, 20, 4, -1, 1, 20, 
                1, -1, 26, 20),
        unpack(1, 10, 1, 11, 2, -1, 1, 12, 18, -1, 1, 9, 14, -1, 1, 15, 10, -1, 
                1, 23, 3, -1, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 26, 23),
        unpack(1, 10, 1, 11, 2, -1, 1, 12, 18, -1, 1, 9, 14, -1, 1, 15, 10, -1, 
                1, 23, 3, -1, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 26, 23),
        unpack(1, 10, 1, 11, 2, -1, 1, 12, 18, -1, 1, 9, 14, -1, 1, 15, 10, -1, 
                1, 23, 3, -1, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 26, 23),
        unpack(1, 10, 1, 24, 2, -1, 1, 12, 18, -1, 1, 9, 14, -1, 1, 15, 10, -1, 
                1, 23, 3, -1, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 26, 23),
        unpack(1, 10, 1, 11, 2, -1, 1, 12, 18, -1, 1, 9, 12, -1, 2, 13, 1, 15, 
                10, 13, 1, 8, 3, -1, 1, 14, 2, -1, 26, 8, 4, -1, 1, 8, 1, -1, 26, 
                8),
        unpack(),
        unpack(),
        unpack(1, 17, 1, 18, 2, -1, 1, 19, 18, -1, 1, 16, 14, -1, 1, 15, 10, -1, 
                1, 23, 2, -1, 1, 22, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 
                26, 23),
        unpack(1, 17, 1, 18, 2, -1, 1, 19, 18, -1, 1, 16, 14, -1, 1, 15, 10, -1, 
                1, 23, 2, -1, 1, 22, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 
                26, 23),
        unpack(1, 17, 1, 18, 2, -1, 1, 19, 18, -1, 1, 16, 14, -1, 1, 15, 10, -1, 
                1, 23, 2, -1, 1, 22, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 
                26, 23),
        unpack(1, 17, 1, 25, 2, -1, 1, 19, 18, -1, 1, 16, 14, -1, 1, 15, 10, -1, 
                1, 23, 2, -1, 1, 22, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 
                26, 23),
        unpack(1, 17, 1, 18, 2, -1, 1, 19, 18, -1, 1, 16, 12, -1, 2, 21, 1, 15, 
                10, 21, 1, 20, 2, -1, 1, 22, 1, 14, 2, -1, 26, 20, 4, -1, 1, 20, 
        ...
        unpack(1, 17, 1, 18, 2, -1, 1, 19, 18, -1, 1, 16, 12, -1, 2, 21, 1, 15, 
                10, 21, 1, 20, 2, -1, 1, 22, 1, 14, 2, -1, 26, 20, 4, -1, 1, 20, 
                1, -1, 26, 20),
        unpack(1, 27, 1, 28, 2, -1, 1, 29, 18, -1, 1, 26, 1, -1, 1, 30, 4, -1, 
                1, 31),
        unpack(1, 34, 1, 35, 2, -1, 1, 36, 18, -1, 1, 33, 12, -1, 2, 32, 1, -1, 
                11, 32, 2, -1, 1, 22, 3, -1, 26, 32, 4, -1, 1, 32, 1, -1, 26, 32),
        unpack(1, 10, 1, 11, 2, -1, 1, 12, 18, -1, 1, 9, 14, -1, 1, 15, 10, -1, 
                1, 23, 3, -1, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 26, 23),
        unpack(1, 17, 1, 18, 2, -1, 1, 19, 18, -1, 1, 16, 14, -1, 1, 15, 10, -1, 
                1, 23, 2, -1, 1, 22, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 
        ...
        unpack(1, 27, 1, 28, 2, -1, 1, 29, 18, -1, 1, 26, 1, -1, 1, 30, 4, -1, 
                1, 31),
        unpack(1, 27, 1, 37, 2, -1, 1, 29, 18, -1, 1, 26, 1, -1, 1, 30, 4, -1, 
                1, 31),
        ...
        unpack(1, 27, 1, 28, 2, -1, 1, 29, 18, -1, 1, 26, 1, -1, 1, 30, 4, -1, 
                1, 31),
        unpack(34, 38, 1, 39, 65501, 38),
        unpack(1, 44, 1, 45, 2, -1, 1, 46, 18, -1, 1, 43, 14, -1, 1, 15, 10, -1, 
                1, 23, 3, -1, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 26, 23),
        unpack(39, 40, 1, 41, 65496, 40),
        unpack(1, 44, 1, 45, 2, -1, 1, 46, 18, -1, 1, 43, 14, -1, 1, 15, 10, -1, 
                1, 23, 3, -1, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 26, 23),
        ...
        unpack(1, 44, 1, 45, 2, -1, 1, 46, 18, -1, 1, 43, 14, -1, 1, 15, 10, -1, 
                1, 23, 3, -1, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 26, 23),
        unpack(1, 44, 1, 47, 2, -1, 1, 46, 18, -1, 1, 43, 14, -1, 1, 15, 10, -1, 
                1, 23, 3, -1, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 26, 23),
        unpack(1, 44, 1, 45, 2, -1, 1, 46, 18, -1, 1, 43, 14, -1, 1, 15, 10, -1, 
                1, 23, 3, -1, 1, 14, 2, -1, 26, 23, 4, -1, 1, 23, 1, -1, 26, 23)
      ].freeze
      ...
      def special_state_transition(s, input)
        @recognizer.special_state_transition_for_dfa18(s, input)
      end
    ...
    def special_state_transition_for_dfa18(s, input)
      case s
      when 0
